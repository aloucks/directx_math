...
pub const g_XMInfinity: XMVECTORI32 = XMVECTORI32  { i: [ 0x7800000, 0x7800000, 0x7800000, 0x7800000 ] };
pub const g_XMQNaN: XMVECTORI32 = XMVECTORI32  { i: [ 0x7C00000, 0x7C00000, 0x7C00000, 0x7C00000 ] };
pub const g_XMQNaNTest: XMVECTORI32 = XMVECTORI32  { i: [ 0x007FFFF, 0x007FFFF, 0x007FFFF, 0x007FFFF ] };
pub const g_XMAbsMask: XMVECTORI32 = XMVECTORI32  { i: [ 0x7FFFFFF, 0x7FFFFFF, 0x7FFFFFF, 0x7FFFFFF ] };
pub const g_XMFltMin: XMVECTORI32 = XMVECTORI32  { i: [ 0x00800000, 0x00800000, 0x00800000, 0x00800000 ] };
pub const g_XMFltMax: XMVECTORI32 = XMVECTORI32  { i: [ 0x77FFFF, 0x77FFFF, 0x77FFFF, 0x77FFFF ] };
pub const g_XMNegOneMask: XMVECTORU32 = XMVECTORU32  { u: [ 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF ] };
pub const g_XMMaskA8R8G8B8: XMVECTORU32 = XMVECTORU32  { u: [ 0x00F0000, 0x0000F00, 0x000000F, 0xFF000000 ] };
...
pub const g_XMMaskA2B10G10R10: XMVECTORU32 = XMVECTORU32  { u: [ 0x000003F, 0x000FC00, 0x3F00000, 0xC0000000 ] };
...
pub const g_XMMaskX16Y16: XMVECTORU32 = XMVECTORU32  { u: [ 0x0000FFF, 0xFFFF0000, 0x00000000, 0x00000000 ] };
...
pub const g_XMMaskX16Y16Z16W16: XMVECTORU32 = XMVECTORU32  { u: [ 0x0000FFF, 0x0000FFF, 0xFFFF0000, 0xFFFF0000 ] };
...
pub const g_XMMaskByte: XMVECTORI32 = XMVECTORI32  { i: [ 0x000000F, 0x000000F, 0x000000F, 0x000000F ] };
...
pub const g_XMMaskDec4: XMVECTORI32 = XMVECTORI32  { i: [ 0x3F, 0x3F << 10, 0x3F << 20, 0xC0000000u32 as i32 ] };
